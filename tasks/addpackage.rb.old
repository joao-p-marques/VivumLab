...
if gl
  ...
  begin
    issue_result = gl.create_issue(VIVUMLAB_PROJECT_ID,
                  "Add #{package_name}",
    ...
    if issue_result.iid
      ...
      branch_result = gl.create_branch(VIVUMLAB_PROJECT_ID,
                                        @branch_name,
                                        'HEAD')
      if !branch_result.nil?
        mr_result = gl.create_merge_request(VIVUMLAB_PROJECT_ID,
